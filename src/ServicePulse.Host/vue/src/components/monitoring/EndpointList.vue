      ...
      <div class="endpoint-row" v-for="(endpoint, index) in endpoints" :key="index" v-show="endpoints.length" v-on:mouseenter="endpoint.hover1 = true" v-on:mouseleave="endpoint.hover1 = false">
        <div class="table-first-col endpoint-name name-overview">
            ...
            <div class="endpoint-status">
              ...
              <span class="warning"  v-tooltip title="No data received from any instance">
              ...
              <span class="warning"  v-tooltip :title="endpoint.errorCount + ` failed messages associated with this endpoint. Click to see list.`">
                <a class="cursorpointer email-errors" @click="navigateToMessageGroup($event, endpoint.serviceControlId)">
